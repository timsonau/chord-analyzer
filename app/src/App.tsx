        ...
        <TabsContent value="about">
          <Card>
            ...
            <CardContent className="space-y-4">
              <p>
                Our chord detection system uses an advanced pattern matching
                algorithm to identify chords from audio recordings.
              </p>
              ...
              <ol className="list-decimal pl-5 space-y-2">
                ...
                <li>
                  Mapping detected notes to our comprehensive chord database
                </li>
                <li>
                  Analyzing the harmonic structure with special emphasis on the
                  3rd and 7th notes that define chord quality
                </li>
                <li>
                  Calculating match percentages for possible chord
                  interpretations
                </li>
                <li>
                  Presenting the most likely chord options ranked by probability
                </li>
              </ol>
              <p className="text-sm text-muted-foreground mt-4">
                This technology provides accurate chord identification for music
                composition, education, and analysis.
              </p>
            </CardContent>
          </Card>
        </TabsContent>
